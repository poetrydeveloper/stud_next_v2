...
156	270038-20251017-101601525-264985/child-4-1760685444779-dyy9j6844	34	\N	\N	2025-10-17 07:17:24.78	2025-10-17 07:17:36.052	\N	f	f	151	54	Щётки-мини	270038		Щётка-мини, нейлоновая щетина	null	1.32	\N	ARRIVED	IN_STORE	\N	2025-10-17 07:17:24.779	\N	0	0	\N	32	\N	MONOLITH	f	\N
...
SELECT pg_catalog.setval('public.cash_events_id_seq', 32, true);
...
SELECT pg_catalog.setval('public.product_unit_logs_id_seq', 546, true);
...
SELECT pg_catalog.setval('public.product_units_id_seq', 167, true);
...
SELECT pg_catalog.setval('public.spines_id_seq', 40, true);
