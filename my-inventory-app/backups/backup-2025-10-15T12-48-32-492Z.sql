...
81	274300-20251015-135813836-692076	19	\N	\N	2025-10-15 10:58:13.837	2025-10-15 10:59:35.642	\N	f	f	\N	35	Щётки для УШМ	274300		Щётка для УШМ проволочная конусная 100мм	null	\N	\N	CANDIDATE	\N	2025-10-15 10:59:35.641	\N	\N	1	0	\N	17	\N	MONOLITH	f	\N
...
SELECT pg_catalog.setval('public.cash_events_id_seq', 18, true);
...
SELECT pg_catalog.setval('public.inventory_snapshots_id_seq', 216, true);
...
SELECT pg_catalog.setval('public.product_images_id_seq', 21, true);
...
SELECT pg_catalog.setval('public.product_unit_logs_id_seq', 318, true);
...
SELECT pg_catalog.setval('public.product_units_id_seq', 102, true);
...
SELECT pg_catalog.setval('public.spines_id_seq', 21, true);
